...
function handleLocationSubmit(event) {
  ...
  if (CookieStand.allLocationsRef.indexOf(name) > -1) {
    CookieStand.all[CookieStand.allLocationsRef.indexOf(name)].minCustomers =
      minCustomers;
    CookieStand.all[CookieStand.allLocationsRef.indexOf(name)].maxCustomers =
      maxCustomers;
    CookieStand.all[CookieStand.allLocationsRef.indexOf(name)].aveCookies =
      aveCookies;
  ...
  let newCookieStand = new CookieStand(
    name,
    minCustomers,
    maxCustomers,
    aveCookies
